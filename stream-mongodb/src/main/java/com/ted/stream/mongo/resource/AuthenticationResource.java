...
import com.ted.stream.mongo.entity.Token;
...
public class AuthenticationResource {
    ...
    public ResponseEntity<Token> authenticate(@RequestBody AuthenticationRequest authenticationRequest) {
        userService.login(authenticationRequest.getUsername(), authenticationRequest.getPassword());
        return new ResponseEntity<Token>(new Token(UUID.randomUUID().toString()), HttpStatus.OK);
    }
}
